...
dati_PUN_completi['PUN'] = [x.replace(',', '.')
                            for x in dati_PUN_completi['PUN']]

dati_PUN_completi['PUN'] = dati_PUN_completi['PUN'].astype(float)

# Creazione del csv

# Ho usato come sepratore il ;
dati_PUN_completi.to_csv('dati_PUN_completi.csv',
